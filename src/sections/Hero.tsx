...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/* First ring */}
      <div className="absolute h-[344px] md:h-[580px] w-[344px] md:w-[580px] border opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      {/* Second ring */}
      <div className="absolute h-[444px] md:h-[780px] w-[444px] md:w-[780px] border border-dashed border-white/20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
      {/* Third ring */}
      <div className="absolute h-[544px] md:h-[980px] w-[544px] md:w-[980px] border border-white opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="absolute h-2 w-2 top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 bg-white rounded-full"></div>
